...
[![Latest Release](https://img.shields.io/github/tag/eventespresso/ADDON_SLUG.svg?style=flat&label=Latest%20Release)](https://github.com/eventespresso/ADDON_SLUG/releases)
[![Travis](https://travis-ci.org/eventespresso/ADDON_SLUG.svg?branch=master)](https://travis-ci.org/eventespresso/ADDON_SLUG)
...
| **Some Links**|     |
|---- | --- |
**Support License** | Support for this add-on is not provided through this repository.  For support you can purchase a [Premium Support License](https://eventespresso.com/product/ADDON_SLUG?ee_ver=ee4&utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=premium+support+license).
**Documentation** | [View Documentation →](https://eventespresso.com/wiki/ADDON_SLUG?utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=view+addon+documentation)
...
> We ask if you are using this to provide a solution for clients that you (or your client) [purchase a support license](https://eventespresso.com/product/ADDON_SLUG?ee_ver=ee4&utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=premium+support+license) for this add-on.
